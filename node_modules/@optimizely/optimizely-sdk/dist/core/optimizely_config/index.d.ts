...
export declare class OptimizelyConfig {
     ...
     */
    static getDeliveryRules(configObj: ProjectConfig, featureVariableIdMap: FeatureVariablesMap, featureId: string, experiments: Experiment[]): OptimizelyExperiment[];
    /**
     ...
     */
    static getExperimentsMapById(configObj: ProjectConfig, featureIdVariableMap: FeatureVariablesMap): {
     ...
     */
    static getFeaturesMap(configObj: ProjectConfig, featureVariableIdMap: FeatureVariablesMap, experimentsMapById: OptimizelyExperimentsMap): OptimizelyFeaturesMap;
}
/**
 ...
 */
export declare function createOptimizelyConfig(configObj: ProjectConfig, datafile: string): OptimizelyConfig;
export {};
