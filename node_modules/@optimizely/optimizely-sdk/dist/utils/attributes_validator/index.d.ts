 ...
 */
export declare function validate(attributes: unknown): boolean;
/**
 ...
 */
export declare function isAttributeValid(attributeKey: unknown, attributeValue: unknown): boolean;
